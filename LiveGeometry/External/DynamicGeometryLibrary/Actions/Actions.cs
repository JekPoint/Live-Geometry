...
namespace DynamicGeometry.Actions
{
    ...
    public class Actions
    {
        ...
        {
            var action = new AddFigureAction(drawing, newFigure);
        ...
        public static void Remove(IFigure figure)
        {
            ...
            var action = new RemoveFigureAction(drawing, figure);
            drawing.ActionManager.RecordAction(action);
        }
        ...
        {
            var drawing = existingFigure.Drawing;
            var action = new ReplaceFigureAction(drawing, existingFigure, newFigure);
            drawing.ActionManager.RecordAction(action);
        }
        ...
        {
            var action = new SetPropertyAction(valueProvider, value);
        ...
        {
            var action = new AddItemAction<T>(list.Add, i => list.Remove(i), item);
            actionManager.RecordAction(action);
        }
