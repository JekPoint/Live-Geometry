...
using ValidationResult = DynamicGeometry.PropertyGrid.Editors.ValidationResult;
...
namespace DynamicGeometry.Styles
{
    ...
    public class StylePickerEditor : SelectorValueEditor, IValueEditor
    {
        ...
        {
            var style = Value.GetValue<IFigureStyle>();
            ...
            var allStyles = style.GetCompatibleStyles();

            var figure = Value.Parent as IFigure;
        ...
        {
            var style = (value as FrameworkElement).Tag as IFigureStyle;
