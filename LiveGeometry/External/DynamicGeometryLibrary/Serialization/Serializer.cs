...
namespace DynamicGeometry.Serialization
{
    ...
    public static class SerializationServiceExtensions
    {
        ...
        {
            var value = new ValueProvider() { Type = typeof(T) };
    ...
    public class SerializationService : ISerializationService
    {
        ...
        {
            var serializer = FindBestSerializer(value);
    ...
    public abstract class SerializerBase<T> : ISerializer
    {
        ...
        public virtual double Priority => 1.0;
    }
    ...
    public class BrushSerializer : ISerializer
    {
        public object Write(IValueProvider value)
        {
            var brush = value.GetValue<object>();
