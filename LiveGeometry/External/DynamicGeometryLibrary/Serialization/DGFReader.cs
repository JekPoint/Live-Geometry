...
namespace DynamicGeometry.Serialization
{
    public class DGFReader
    {
        ...
        private void AddButtonDependencies(
            ...
            IList container)
        {
            foreach (var dependency in ReadIndices(section, dependencyType))
            {
        ...
        private IEnumerable<int> ReadIndices(IniFile.Section section, string key)
        {
            ...
            var currentKey = key + "#" + index.ToString();
        ...
        {
            var numberOfPoints = section.ReadInt("NumberOfPoints");
        ...
        void ReadIntersectionPoint(IniFile.Section section)
        {
            ...
            Actions.Actions.Add(drawing, point2);
        ...
        void ReadArc(IniFile.Section section)
        {
            ...
            Actions.Actions.Add(drawing, endPoint1);
            Actions.Actions.Add(drawing, endPoint2);
