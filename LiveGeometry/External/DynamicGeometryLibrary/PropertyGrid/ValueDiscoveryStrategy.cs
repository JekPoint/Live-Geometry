...
namespace DynamicGeometry.PropertyGrid
{
    ...
    public abstract class ValueDiscoveryStrategy : IValueDiscoveryStrategy
    {
        ...
        {
            var attribute = type.GetAttribute<PropertyDiscoveryStrategyAttribute>();
            if (attribute != null)
            {
    ...
    public class PropertyDiscoveryStrategy : ValueDiscoveryStrategy
    {
        ...
        protected virtual IEnumerable<IValueProvider> CreateValueProviders(IEnumerable<PropertyInfo> properties, object editableObject)
        {
            ...
            {
                var result = PropertyDiscoveryStrategy.CreateValueProvider(editableObject, p);
                yield return result;
            }
        }
        ...
        {
            var provider = editableObject as ICustomPropertyProvider;
            if (provider != null)
            {
