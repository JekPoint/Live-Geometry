...
namespace DynamicGeometry.UI
{
    public class DrawingHost : Grid
    {
        ...
        public Drawing CurrentDrawing => this.DrawingControl.Drawing;

        public Ribbon.Ribbon Ribbon { get; set; }
        ...
        void FigureExplorer_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                var deselectedFigure = deselected as IFigure;
            ...
            {
                var selectedFigure = selected as IFigure;
