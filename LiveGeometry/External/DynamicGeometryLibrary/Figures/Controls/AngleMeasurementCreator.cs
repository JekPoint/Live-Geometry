...
namespace DynamicGeometry.Figures.Controls
{
    ...
    public class AngleMeasurementCreator : FigureCreator
    {
        ...
        protected override void CreateTempResults()
        {
            ...
            Actions.Actions.Add(Drawing, Factory.CreateAngleArc(Drawing, FoundDependencies));
        }

        public override string Name => "Angle";

        public override string HintText => "Click an angle vertex, and then click two points on the angle sides to measure the angle.";
