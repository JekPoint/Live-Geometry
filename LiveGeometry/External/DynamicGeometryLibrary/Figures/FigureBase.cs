...
using INotifyPropertyChanging = DynamicGeometry.PropertyGrid.INotifyPropertyChanging;
...
namespace DynamicGeometry.Figures
{
        ...
        INotifyPropertyChanging
    {
        ...
        protected PointPair CanvasLogicalBorders => ToLogical(Canvas.GetBorderRectangle());
        ...
        {
            for (var i = 0; i < mDependencies.Count; i++)
            {
        ...
        public virtual Point Center => new Point(0, 0);
