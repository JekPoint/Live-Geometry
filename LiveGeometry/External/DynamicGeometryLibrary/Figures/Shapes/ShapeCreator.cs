    ...
    public abstract class ShapeCreator : FigureCreator
    {
        ...
        public class ShapeDialog
        {
            ...
            public void AddPoint()
            {
                ...
                {
                    var x = double.Parse(X, CultureInfo.CurrentUICulture);
                    var y = double.Parse(Y, CultureInfo.CurrentUICulture);

                    var first = (FreePoint)this.parent.FoundDependencies.FirstOrDefault(f => f is FreePoint);
