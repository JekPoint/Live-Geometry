...
namespace DynamicGeometry.Figures.Shapes
{
    public class Arrow : Polygon
    {
        ...
        public override void UpdateVisual()
        {
            ...
            var parentLine = Dependencies.ElementAt(0) as LineBase;
            if (parentLine != null)
            {
            ...
            var arrowLength = size;// ToLogical(16);
            var arrowWidth = size;// 1.0 / 3;
            var shaftWidth = arrowWidth / 3;
            var triangleBase = new Point(
