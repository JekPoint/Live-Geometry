...
namespace DynamicGeometry.Figures.Coordinates
{
    public class AxisLabel
    {
        ...
        {
            var old = TextBlock.GetCoordinates();
            if (old != coordinates)
            {
    ...
    public class AxisLabelRange
    {
        ...
        public Drawing Drawing => Collection.Drawing;

        public CoordinateSystem CoordinateSystem => Drawing.CoordinateSystem;
        ...
        void RemoveExcessElements(List<AxisLabel> List, int count)
        {
            ...
            for (var i = List.Count - count; i < List.Count; i++)
            {
        ...
        void AddMissingElements(List<AxisLabel> List, int count)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                List.Add(newLabel);
                var textBlock = newLabel.TextBlock;
