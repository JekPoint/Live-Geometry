...
namespace DynamicGeometry.Figures.Lines
{
    public class Vector : CompositeFigure, ILengthProvider
    {
        ...
        public PointPair Coordinates => Line.Coordinates;

        public double Magnitude => Line.Length;
        ...
        public double Angle
        {
            get => Direction.ToDegrees();
            set => Line.Angle = value;
        }

        public double Direction => Math.GetAngle(Coordinates.P1, Coordinates.P2);
