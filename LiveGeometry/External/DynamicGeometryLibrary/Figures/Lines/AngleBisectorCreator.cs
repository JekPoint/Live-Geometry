...
namespace DynamicGeometry.Figures.Lines
{
    ...
    public class AngleBisectorCreator : FigureCreator
    {
        ...
        public override string Name => "Angle Bisector";

        public override string HintText => "Click an angle vertex, then click two points on the angle sides to create an angle bisector. You can also click an angle measurement.";
